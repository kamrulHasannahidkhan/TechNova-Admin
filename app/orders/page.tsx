          ...
          {filteredOrders.map((o) => (
            ...
            >
              ...
              <div className="flex justify-between items-start flex-wrap gap-3 pb-4 border-b border-slate-200">
                ...
                <div className="text-right flex items-center sm:flex-col justify-between sm:justify-start w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200 gap-1">
                  {o.total !== undefined && (
                  ...
                  <div className="flex items-center gap-2">
                    {tab === "ordered" && o.orderStatus === "confirmed" && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700 font-medium p-1 hover:bg-blue-50 rounded-lg transition"
                      >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-xs text-rose-500 hover:text-rose-600 transition font-medium p-1 hover:bg-rose-50 rounded-lg"
                    >
